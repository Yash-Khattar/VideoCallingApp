...
import(
	...
	"os"
	"time"
	"video-calling-app/internal/handlers"
	w "video-calling-app/pkg/webrtc"
...
func Run() error {
    ...
    // telling that engine access all files under views folfer and all html files
